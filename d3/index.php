...
<html>
    <head>
        ...
        <script>
            ...
            function searchForm(addressId, btnId, dpId, latId, lngId){
        ...
        <section>
            <div class="carousel carousel-slider center" id="main-carousel" data-indicators="true">
                ...
                <div class="carousel-fixed-item center">
                  <form action="search.php" method="get" class="hide-on-small-only">
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col s10 m6 l6">
                          <input type="button" onclick="searchForm('location-input1', 'searchHiddenBtn1', 'datepicker1', 'lat1', 'lng1')" class="btn searchBtn" value="Search" />
                          <input type="submit" id="searchHiddenBtn1" class="hide" value="Search" />
                      </div>
                    </div>
                  </form>
...
<?php }?>
      ...
      <div id="modal1" class="modal bottom-sheet grey-gradient-left">
        ...
        <!-- Popup Modal -->
          ...
          <!-- Search Modal -->
          <div id="searchModal" class="modal bottom-sheet hide-on-med-and-up" style="overflow: hidden;">
            <div class="modal-content" style="padding-left: 0;padding-top: 0;padding-bottom: 0;">
              ...
              <div class="modal-footer" style="position: fixed;bottom: 0px;">
                <input type="button" onclick="searchForm('location-input2', 'searchHiddenBtn2', 'datepicker2', 'lat2', 'lng2')" class="btn searchBtn" value="Search" style="float: left;" />
