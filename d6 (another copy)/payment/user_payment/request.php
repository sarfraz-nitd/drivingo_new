...
function enter_into_db($user_id, $school_id, $package_id, $prid){
	global $mysqli;
	$query = "INSERT INTO `userPayment`(`id`, `school_table`, `user_id`, `school_id`, `package_id`, `prid`, `user_table`) VALUES ('','".$table."','".$user_id."','".$school_id."','".$package_id."','".$prid."', '".$_SESSION['table']."')";
