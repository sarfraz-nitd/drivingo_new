...
/*PROCESS*/
	...
	if(isset($_GET['user_type'])){
		...
		if($_GET['user_type'] == 'school'){
			$_SESSION['type'] = 'd_school';
		} else {
			$_SESSION['type'] = 'user';
		}
	}
	...
	$redirect_url='http://localhost/drivingo_new/d6/fblogin/';
	...
	//logout
	$logout = 'http://localhost/drivingo_new/d6/fblogin/index.php?logout=true';
